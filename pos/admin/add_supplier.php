...
if (isset($_POST['addSupplier'])) {
  ...
  if (empty($_POST["shopp"]) || empty($_POST["cfirst"]) ||empty($_POST["cfirst"]) || empty($_POST["clast"]) || empty($_POST['cgender']) || empty($_POST['ccontact']) || empty($_POST['cage']) || empty($_POST['cstreet']) || empty($_POST['ccity']) || empty($_POST['cprovince'])) {
    ...
    $postQuery = "INSERT INTO supplier (address_id, contact, first_name, last_name, gender, age, shop_name) VALUES(?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('sssssss', $currentID, $contact, $first_name, $last_name, $gender, $age , $shop);
    $postStmt->execute();
              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col">
                    ...
                    <input type="text" name="cfirst" class="form-control">
                  </div>
                  <div class="col">
                  ...
                  <div class="col">
                    ...
                    <input type="text" name="shopp" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
