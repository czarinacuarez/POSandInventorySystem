...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
  $adn = "DELETE supplier, address, street, city, province FROM  supplier INNER JOIN address ON supplier.address_id = address.address_id
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  supplier INNER JOIN address ON supplier.address_id = address.address_id INNER JOIN city ON address.city_id = city.city_id 
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="suppliers.php?delete=<?php echo $cust->supplier_id; ?>">
                          <button class="btn btn-sm btn-danger">
                            <i class="fas fa-trash"></i>
                            Delete
                          </button>
                        </a>
                        <a href="update_suppliers.php?update=<?php echo $cust->supplier_id; ?>">
