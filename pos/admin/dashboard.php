            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    LEFT JOIN staff ON staff.staff_id = transactions.staff_id ORDER BY `date` DESC LIMIT 7 ";
        ...
        <div class="col-xl-12">
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Recent Products Added</h3>
                </div>
                <div class="col text-right">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class='text-success' scope="col"><b>Amount</b></th>
                    <th scope="col"><b>Date Added</b></th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  $ret = "SELECT product.product_code, product.product_name, product.product_price, category.product_category , product.created_at FROM   product  INNER JOIN  category ON product.category_id = category.category_id ORDER BY `product`.`created_at` DESC LIMIT 7 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
                  ...
                  ?>
                    <tr>
                      ...
                      <?php echo $payment->product_code; ?>
                      </th>
                      <td>
                      <?php echo $payment->product_name; ?>
                      </td>
                      <td>
                      <?php echo $payment->product_category; ?>
                      </td>
                      <td class='text-success'>
                      ₱<?php echo $payment->product_price; ?>
                      </td>
